...
import { IArticle, IDeleteArticleAction, IOpenArticleAction } from 'types/articlesTypes';
...
const Article: React.FC<IProps> = ({
  title, content, id, articleOpen, setOpenArticle, deleteArticle
}) => {
  ...
  const handleDeleteArticle = () => { deleteArticle(id) }
